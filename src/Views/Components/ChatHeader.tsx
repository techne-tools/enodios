...
export const ChatHeader = memo(({ agentName, isSaving, onNewChat, onOpenSettings, onToggleConversationList, onToggleSearch, onToggleSessionSettings, onToggleAuditLog, onToggleReasoning, showReasoning }: ChatHeaderProps): ReactElement => {
  return (
